...
<p align="center">
  <a href="https://github.com/Moulendu-Chowley/AriaMusic">
    <img src="https://cdn.discordapp.com/avatars/875635121770889257/adc4fd956872a72814b70448d1fddd40.webp?size=512" alt="AriaMusic" width="200" height="200">
  </a>

  <h1 align="center">AriaMusic</h1>
  <p align="center">AriaMusic is a Discord music bot that uses Discord.js, lavalink-client, and TypeScript.
    <br />
    <br />
    <a href="https://discord.com/oauth2/authorize?client_id=1343814433134346241&permissions=279209954560&response_type=code&redirect_uri=https%3A%2F%2Fdiscord.gg%2Fkhfw8z6gg9&integration_type=0&scope=bot+guilds+applications.commands">Invite AriaMusic</a>
    ·
...
1. Clone the AriaMusic repository:

```bash
git clone https://github.com/Moulendu-Chowley/AriaMusic.git
```

2. Change to the AriaMusic directory:
...
Make sure that your User ID is listed under `OWNER_IDS` in `.env`. In the Discord server with AriaMusic, run
...
Thank you for your interest in contributing to AriaMusic! Here are some guidelines to follow when contributing:
...
5. Submit a pull request with your changes.
   Your contribution will be reviewed by the project maintainers, and any necessary feedback or changes will be discussed with you. We appreciate your help in making AriaMusic better!

## 🔐 License

Distributed under the GPL-3.0 license. See [![LICENSE](https://img.shields.io/github/license/Moulendu-Chowley/AriaMusic?style=social)](https://github.com/Moulendu-Chowley/AriaMusic/blob/main/LICENSE) for more information [READ](https://discord.com/channels/942117923001098260/942120006219624469/1278087961774129314).
...
<a href="https://github.com/Moulendu-Chowley/AriaMusic/graphs/contributors">
<img src="https://contrib.rocks/image?repo=Moulendu-Chowley/AriaMusic" />
</a>

[version-shield]: https://img.shields.io/github/package-json/v/Moulendu-Chowley/AriaMusic?style=for-the-badge
