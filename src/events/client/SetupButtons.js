...
export default class SetupButtons extends Event {
    ...
    async run(interaction) {
        ...
        const embed = this.client
            ...
            .setDescription(`[${title}](${uri}) - ${isStream ? T(locale, "event.setupButton.live") : this.client.utils.formatTime(duration)} - ${T(locale, "event.setupButton.requested_by", { requester: player.queue.current.requester.id })}`)
            ...
            switch (interaction.customId) {
                ...
                case "SKIP_BUT": {
                    ...
                    const newEmbed = this.client
                        ...
                        .setColor(this.client.color.main)
                        .setDescription(`[${newTrack?.title}](${newTrack?.uri}) - ${newTrack?.isStream ? T(locale, "event.setupButton.live") : this.client.utils.formatTime(newTrack?.duration)} - ${T(locale, "event.setupButton.requested_by", { requester: (player.queue.current?.requester).id })}`)
